...
def update():
    ...
    if badge.pressed(BUTTON_C) and weather_data and not loading:
        if use_fahrenheit:
            # F+mph → C+mph
    ...
    if auto_refresh and last_update and (badge.ticks - last_update) > 300000 and not loading:
        fetch_weather()
