...
class Snake:
    ...
    def draw(self):
        screen.pen = color.rgb(*SNAKE_COLOR)
        for x, y in self.segments:
            screen.shape(shape.rectangle(x * GRID_SIZE, y * GRID_SIZE, SQUARE_SIZE, SQUARE_SIZE))
...
class Commit:
    ...
    def draw(self):
        ...
        screen.shape(shape.rectangle(self.x * GRID_SIZE, self.y * GRID_SIZE, SQUARE_SIZE, SQUARE_SIZE))
...
def play():
    ...
    # Update game logic
    if badge.ticks - last_update > update_interval:
