...
class Obstacle:
    ...
    def draw(self):
        ...
        screen.blit(sprites.sprite(0, 0), rect(self.x, self.gap_y - 72, 24, 24))
        screen.blit(sprites.sprite(0, 0), rect(self.x, self.gap_y - 48, 24, 24))
        screen.blit(sprites.sprite(1, 0), rect(self.x, self.gap_y - 24, 24, 24))  # spikes, yikes!

        # draw the bottom half off the obstacle
        screen.blit(sprites.sprite(1, 0), rect(self.x, self.gap_y + self.gap_height, 24, -24))  # spikes, yikes!
        screen.blit(sprites.sprite(0, 0), rect(self.x, self.gap_y + self.gap_height + 24, 24, -24))
        screen.blit(sprites.sprite(0, 0), rect(self.x, self.gap_y + self.gap_height + 48, 24, -24))
